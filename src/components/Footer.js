				...
				<div className="container text-md-left">
					<div className="row text-md-left">
						<div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
							<h5 className="text-uppercase mb-4 font-weight-bold text-dark">Laundry.in</h5>
						...
						<div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
							...
							<div className="row">
								...
								<h6 className="text-dark">Isekai kara</h6>
							</div>
							<div className="row">
								<h6 className="text-info">Email: </h6>
								<h6>laundry.in@gmail.com</h6>
							</div>
							<div className="row">
								<h6 className="text-info">Telp: </h6>
								<h6>(+62)89697640614</h6>
							</div>
						</div>
					</div>
				</div>
